                ...
                awaitAll(
                    async {
                        try {
                            ...
                            val controller = LastfmApi.searchArtists(query)
                    ...
                    async {
                        try {
                            ...
                            val controller = LastfmApi.searchAlbums(query)
                    ...
                    async {
                        try {
                            ...
                            val controller = LastfmApi.searchTracks(query)
                    ...
                    async {
                        try {
                            ...
                            if (resultsData.artists != null) {
                                MusicorumResource.fetchArtistsResources(resultsData.artists!!.getAllItems().take(3))
                            }
                            null
                        } catch (e: Exception) {
                    ...
                    async {
                        try {
                            ...
                            if (resultsData.tracks != null) {
                                MusicorumResource.fetchTracksResources(resultsData.tracks!!.getAllItems().take(3))
                            }
                            null
                        } catch (e: Exception) {
