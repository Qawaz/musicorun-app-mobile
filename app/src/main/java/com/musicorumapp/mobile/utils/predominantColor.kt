...
fun composeColorToHSL (color: Color): HSL {
    return RGB(resolveVector(color.red), resolveVector(color.green), resolveVector(color.blue)).toHSL()
}
